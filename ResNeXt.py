...
class Resnext:
    ...
    def launch(self, dataset_dir, on_epoch_end):
        ...
        model = models.resnext(model_name=self.parameters.model_name,
                                 train_mode=True,
                                 use_pretrained=self.parameters.use_pretrained,
                                 feature_extract=self.parameters.feature_extract,

...
class TrainResnext(dnntrain.TrainProcess):
    ...
    def __init__(self, name, param):
        ...
        if param is None:
            self.set_param_object(TrainResnextParam())
        else:
            self.set_param_object(copy.deepcopy(param))

        self.trainer = resnext.Resnext(self.get_param_object())
...
class TrainResnextFactory(dataprocess.CTaskFactory):
    ...
    def __init__(self):
        ...
        self.info.short_description = "Training process for ResNeXt convolutional network."
        self.info.authors = "Ikomia"
        self.info.version = "1.5.0"
        self.info.year = 2020
        self.info.license = "MIT License"
        self.info.repository = "https://github.com/Ikomia-hub/train_torchvision_resnext"
